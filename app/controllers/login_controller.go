...
func (server *Server) Register(w http.ResponseWriter, r *http.Request) {
	...
	err = server.DB.Debug().Model(&models.Profile{}).AddForeignKey("user_id", "users(id)", "cascade", "cascade").Error
	if err != nil {
	...
	err = server.DB.Debug().Model(&models.Profile{}).Create(&profile).Error
	if err != nil {
